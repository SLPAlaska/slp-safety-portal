...
export default function LanyardSRLInspection() {
  ...
  const checkDuplicateInspection = async (equipmentId) => {
    ...
    let data = []; try { data = (await fieldData('recent_check', { table: 'lanyard_srl_inspections', id: equipmentId })).rows; } catch (e) { console.error(e); } const error = null;
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ background: 'white', borderRadius: '16px', boxShadow: '0 25px 50px -12px rgba(0,0,0,0.4)', overflow: 'hidden' }}>
          ...
          <form onSubmit={handleSubmit} style={{ padding: '25px' }}>
            ...
            {/* Photo Documentation */}
            <MultiPhotoUpload ref={photoRef} formType="lanyard-srl-inspection" />
