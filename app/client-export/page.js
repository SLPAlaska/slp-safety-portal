...
export default function ClientExport() {
  ...
  const exportData = async () => {
    ...
    try {
      ...
      // Convert to CSV or trigger Excel download
      if (exportFormat === 'csv') {
        downloadCSV(allData);
      } else {
  ...
  const downloadExcel = async (data) => {
    // For Excel, we'll use a library or convert to CSV for now
          ...
          <div style={styles.filterRow}>
            ...
            <div>
              ...
              >
                ...
                <option>Swanson River</option>
                <option>Ninilchik</option>
                <option>Nikiski</option>
                <option>Deadhorse</option>
                <option>Prudhoe Bay</option>
                <option>Kuparuk</option>
