...
const FORM_CATEGORIES = {
  ...
  'Field Forms': {
    ...
    forms: {
      ...
      'Risk Control Conversation': 'risk_control_conversation',
      'SAIL Log Entry': 'sail_log',
      'Slickline Safety Audit': 'slickline_safety_audit',
      'STOP & Take 5': 'stop_take_5',
      'Surface Condition Audit': 'surface_condition_audit',
      'SWPPP Inspection': 'swppp_inspection',
      'Task/Crew Audit': 'task_crew_audit',
      'Toolbox Meeting Quality Assessment': 'toolbox_meeting_assessment',
      'Welding/Fab Shop Audit': 'welding_fab_shop_audit',
      'Welding/Grinding Audit': 'welding_grinding_audit',
    }
  },
  'Monthly Inspections': {
    icon: '\u{1F4C5}',
