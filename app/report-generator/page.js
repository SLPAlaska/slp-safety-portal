...
<div class="cover-footer"><strong>CONFIDENTIAL</strong><br>Powered by Predictive Safety Analytics™ | © 2026 SLP Alaska, LLC</div>
</div>
...
<p><strong>Powered by Predictive Safety Analytics™</strong></p>
<p>© 2026 SLP Alaska, LLC. All rights reserved.</p>
  ...
  return (
    <div style={styles.container}><div style={styles.wrapper}>
      ...
      <div style={styles.footer}><strong>Powered by Predictive Safety Analytics™</strong><br/>© 2026 SLP Alaska, LLC</div>
    </div></div>
  );
}
