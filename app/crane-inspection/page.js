...
export default function CraneInspection(){
  ...
  const [formData,setFormData]=useState({
    operatorName:'',date:new Date().toLocaleDateString('en-CA'),shift:'',location:'',company:'',craneNumber:'',craneType:'',make:'',model:'',serialNumber:'',capacity:'',hourMeter:'',lastAnnualInspection:'',
  ...
  return(<div style={s.container}><div style={s.formContainer}>
    ...
    <div style={s.content}><form onSubmit={handleSubmit}>
      ...
      {/* FLUID LEVELS & ENGINE */}
      <InspectionSection title="🛢️ Fluid Levels & Engine" items={FLUID_ITEMS} color={s.sectionCyan}/>
      
      {/* BOOM & STRUCTURE */}
      <InspectionSection title="🏗️ Boom & Structure" items={BOOM_ITEMS} color={s.sectionOrange} critical="Any cracks, deformation, or damage to structural components = DO NOT OPERATE"/>
      
      {/* WIRE ROPE & RIGGING */}
      <InspectionSection title="🪝 Wire Rope & Rigging" items={RIGGING_ITEMS} color={s.sectionRed} critical="Wire rope with broken wires, kinks, bird caging, or corrosion = DO NOT OPERATE"/>
      
      {/* SAFETY DEVICES */}
      <InspectionSection title="🛡️ Safety Devices" items={SAFETY_ITEMS} color={s.sectionPurple} critical="Non-functional safety devices = DO NOT OPERATE"/>
      
      {/* OUTRIGGERS */}
      <InspectionSection title="🦿 Outriggers & Stabilizers" items={OUTRIGGER_ITEMS} color={s.sectionGreen}/>
      
      {/* BRAKES & CONTROLS */}
      <InspectionSection title="🔄 Brakes & Controls" items={BRAKE_ITEMS} color={s.sectionYellow}/>
      
      {/* CAB, LIGHTS & ALARMS */}
      <InspectionSection title="🚗 Cab, Lights & Alarms" items={CAB_ITEMS} color={s.sectionIndigo}/>
      
      {/* DOCUMENTATION */}
      <InspectionSection title="📄 Documentation & Signage" items={DOC_ITEMS} color={s.sectionTeal}/>
      
      {/* SITE CONDITIONS */}
      <div style={s.section}><div style={{...s.sectionHeader,...s.sectionAmber}}>🌤️ Site & Weather Conditions</div><div style={s.sectionBody}>
