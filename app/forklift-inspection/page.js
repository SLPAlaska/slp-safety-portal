...
export default function ForkliftInspection(){
  ...
  const [formData,setFormData]=useState({
    operatorName:'',date:new Date().toLocaleDateString('en-CA'),shift:'',location:'',company:'',forkliftNumber:'',forkliftType:'',make:'',model:'',hourMeter:'',
  ...
  const handleSubmit=async(e)=>{e.preventDefault();setIsSubmitting(true);
    try{
      const { error } = await safeInsert('forklift_inspections', [{
