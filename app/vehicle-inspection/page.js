...
export default function VehicleInspection(){
  ...
  const [formData,setFormData]=useState({
    driverName:'',date:new Date().toLocaleDateString('en-CA'),location:'',company:'',vehicleNumber:'',licensePlate:'',vehicleType:'',odometer:'',trailerNumber:'',trailerLicense:'',
