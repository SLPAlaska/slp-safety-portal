...
export default function ConfinedSpaceEntry(){
  ...
  const [formData,setFormData]=useState({
    permitInitiator:'',date:new Date().toLocaleDateString('en-CA'),entryType:'',company:'',location:'',phoneRadio:'',spaceId:'',spaceDescription:'',entrySupervisor:'',purposeOfEntry:'',
  ...
  const handleSubmit=async(e)=>{e.preventDefault();setIsSubmitting(true);
    try{
      ...
      const{error}=await safeInsert('cse_permits', [{
      ...
      await registerRecordKey('cse_permits',permitNumber,code);
