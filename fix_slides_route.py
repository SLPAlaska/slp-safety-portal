...
route = r"""export const dynamic = 'force-dynamic'
...
os.makedirs(r"C:\Users\brian\OneDrive\SLP HARD DRIVE\00000-2026\GitHub Safety Portal\app\api\lms\slides", exist_ok=True)
path = r"C:\Users\brian\OneDrive\SLP HARD DRIVE\00000-2026\GitHub Safety Portal\app\api\lms\slides\route.js"
with open(path, 'w', encoding='ascii', errors='replace') as f:
    f.write(route)
print("slides/route.js written successfully")
